<template>
	<div id="show">
		...
		<el-table :data="tableData" border style="width: 95%;margin:auto;margin-top: 30px;">
			...
			<el-table-column prop="date" label="出库单号" width="150">
			</el-table-column>
			<el-table-column prop="name" label="出库门店" width="180">
			</el-table-column>
			<el-table-column prop="address" label="出库类型" width="170">
			</el-table-column>
			<el-table-column prop="jbman" label="出库数量" width="90">
			</el-table-column>
			<el-table-column prop="crkzt" label="经办人员" width="140">
			</el-table-column>
			<el-table-column prop="zdman" label="制单人员" width="120">
			</el-table-column>
			<el-table-column prop="zddata" label="制单日期" width="130">
			</el-table-column>
			<el-table-column prop="shzt" label="审核状态" width="110">
			</el-table-column>
