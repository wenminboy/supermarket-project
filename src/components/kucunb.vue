<template>
	<div id="show">
		...
		<el-table :data="tableData" border style="width: 95%;margin:auto;margin-top: 30px;">
			...
			<el-table-column prop="date" label="调拨单号" width="150">
			</el-table-column>
			<el-table-column prop="name" label="调出门店" width="180">
			</el-table-column>
			<el-table-column prop="address" label="调入门店" width="270">
			</el-table-column>
			<el-table-column prop="jbman" label="经办人员" width="80">
			</el-table-column>
			<el-table-column prop="zdman" label="制单人员" width="80">
			</el-table-column>
			<el-table-column prop="zddata" label="制单日期" width="110">
			</el-table-column>
			<el-table-column prop="shzt" label="审核状态" width="110">
			</el-table-column>
			<el-table-column prop="crkzt" label="出入库状态" width="110">
			</el-table-column>
