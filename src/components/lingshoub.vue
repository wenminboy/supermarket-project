	...
	<div id="show">
		...
		<div class="big">
			<el-table :data="tableData" border style="width: 90%;margin: 20px auto; ">
				<el-table-column prop="date" label="订单号" width="170">
				</el-table-column>
			
				<el-table-column prop="province" label="下单时间" width="200">
				</el-table-column>
				<el-table-column prop="city" label="下单电话" width="170">
				</el-table-column>
				<el-table-column prop="address" label="门店名称" width="290">
				</el-table-column>
				<el-table-column prop="zip" label="终端编码" width="110">
				</el-table-column>
				...
				<el-table-column label="操作">
					<template slot-scope="scope">
						<el-button @click="handleClick(scope.row),chakan()" type="text" size="small">详情</el-button>
					</template>
				</el-table-column>
			</el-table>
