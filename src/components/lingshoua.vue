	...
	<div id="show">
		...
		<div class="big">
			<el-table :data="tableData" border style="width: 90%;margin: 20px auto; ">
				...
				<el-table-column prop="province" label="下单时间" width="150">
				</el-table-column>
				<el-table-column prop="city" label="下单电话" width="150">
				</el-table-column>
				<el-table-column prop="address" label="所属区域" width="290">
				</el-table-column>
				<el-table-column prop="zip" label="终端编码" width="80">
				</el-table-column>
