<template>
	<div id="show">
		...
		<div class="big">
			...
			<div class="inp">
				<div>
					<label>采购单号：</label><input v-model="date" >
					<br>
					<label>审核状态：</label><input v-model="shzt">
					<br>
					<label>采购门店：</label><input v-model="name" >
				</div>
				<div>
					<label>供应商：</label><input v-model="name">
					<br>
					<label>采购人员：</label><input v-model="name">
					<br>
					<label>备注：</label><input v-model="aa">
				</div>
			</div>
			<div class="big">
			...
			<div class="hedui">
				<label>制单人员：</label><input class="oo" v-model="name" >
				<label>制单日期：</label><input class="oo" v-model="zip">
				<label>采购单号：</label><input class="oo" v-model="date">
				<label>是否核审：</label><input class="oo" v-model="shzt">
			</div>
