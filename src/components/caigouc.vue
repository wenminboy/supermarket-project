	...
	<div id="show">
		...
		<div class="big">
			<el-table :data="tableData" border style="width: 90%;margin: 20px auto; ">
				<el-table-column prop="date" label="采购退货单号" width="150">
				</el-table-column>
				<el-table-column prop="name" label="供应商" width="120">
				</el-table-column>
				<el-table-column prop="province" label="退货金额" width="120">
				</el-table-column>
				<el-table-column prop="city" label="采购关联单号" width="120">
				</el-table-column>
				<el-table-column prop="address" label="制单人员" width="240">
				</el-table-column>
